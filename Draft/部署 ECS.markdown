...
* [1. 配置 ECS](#1-配置-ecs)
   * [1.1 选购套餐](#11-选购套餐)
   * [1.2 选择系统](#12-选择系统)
   * [1.3 重新设置登录密码](#13-重新设置登录密码)
   * [1.4 添加 SSH 密钥](#14-添加-ssh-密钥)
* [2. 配置 Docker](#2-配置-docker)
   * [2.1 配置镜像地址](#21-配置镜像地址)
   * [2.2 启动 Portainer](#22-启动-portainer)
   * [2.3 登陆 Portainer](#23-登陆-portainer)
* [3. 配置数据库](#3-配置数据库)
   * [3.1 Docker 拉取镜像](#31-docker-拉取镜像)
   * [3.2 编写 conf 文件](#32-编写-conf-文件)
   * [3.3 编写 compose 文件](#33-编写-compose-文件)
* [4. 配置程序环境](#4-配置程序环境)
   * [4.1 安装 git/jdk/maven/nginx/npm/nodejs](#41-安装-gitjdkmavennginxnpmnodejs)
   * [4.2 配置 Nginx](#42-配置-nginx)
   * [4.3 授予权限](#43-授予权限)
* [5. 域名](#5-域名)
   * [5.1 解析](#51-解析)
   * [5.2 备案（ICP + 公安）](#52-备案icp-公安)
   * [5.3 签发证书](#53-签发证书)
* [6. 运行项目](#6-运行项目)
   * [6.1 拉取 Git](#61-拉取-git)
   * [6.2 构建前端](#62-构建前端)
   * [6.3 启动 Docker 容器](#63-启动-docker-容器)
   * [6.4 初始化数据](#64-初始化数据)
   * [6.5 构建后端](#65-构建后端)
* [7. 添加基本防护](#7-添加基本防护)
...
4. 接受电话进行客服验证：会问姓名、身份证后 6 位、项目名称，最后进行项目信息的确认

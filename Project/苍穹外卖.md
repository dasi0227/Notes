...
定义上下文类，这里主要就是一个 `IdContext` 类，包含一个静态线程本地变量，普通的 static 变量是所有线程共享的，但是 ThreadLocal 的内部机制是 **JDK 在每个线程对象里都维护了一个共同的 ThreadLocalMap，这个 Map 的 key 是线程实例，value 就是存的值**。
...
![image-20250821215520441](./attachments/image/SpringMVC202508212155068_91727d.png)
...
![image-20250821223750291](./attachments/image/SpringMVC202508212237471_0f8101.png)

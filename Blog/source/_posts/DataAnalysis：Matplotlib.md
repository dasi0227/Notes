...
description: 线图 plot、子图 subplot、饼图 pie、散点图 scatter、柱状图 bar、直方图 hist、图片处理 im
abbrlink: d1e3c468
date: 2025-04-01 14:30:15
---
...
> 为了方便，本笔记代码都用 `plt` 代替 `pyplot`，并且省略了 `plt.figure()` 和 `plt.show()`
